...
public class Ex01_If {
	public static void main(String[] args) {
		...
		int value1 = 5;
		if (value1 > 3) {
			System.out.println("실행1 : 조건이 참일때");
		}
		...
		//if ~ else 는 삼항연산자로 변환이 가능
		
		System.out.println((bool1)? "실행7" : "실행8"); //참이므로 "실행7"
		System.out.println((bool2)? "실행7" : "실행8"); //거짓이므로 "실행8"
		...
		if (value3 >= 90) {
			...
			System.out.println("B 학점, 점수 : " + value3);	//실행후에 if문을 빠져나옴
		}else if (value3 >= 70) {
		...
		if (value3 >= 90) {
			...
			System.out.println("C 학점, 점수 : " + value3);	//실행후에 if문을 빠져나옴
		}else if (value3 >= 80) {
		...
		}else if ( value3 <90 && value3 >= 80){ //&&는 둘다 트루여야하니까
		...
		/*
		 * if 문에서 실행문이 하나일때의 {} 를 생략 할 수 있다.(권장하진 않음)
		 */
