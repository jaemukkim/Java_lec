...
public class MethodOfString {
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a', 8));	//9 / 8번방에서 오른쪽으로 검색 시작
		System.out.println(str1.lastIndexOf('a', 8));//7 / 8번방에서 왼쪽으로 검색
		...
		System.out.println(str1.lastIndexOf("bye"));	//-1 ★중요★(값이 존재하지않는 경우)
		System.out.println();
		...
		String str4 = String.valueOf(false); // boolean타입 false를 String으로 변환
		...
		String str6 = "안녕" + 3; // 안녕3, + : 연산자를 사용할때 자동 변환
