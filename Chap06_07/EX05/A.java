package chap06_07.Ex05;
	...
	// public, protected, default(생략해서 사용), private
		//클래스 이름, 필드명, 메소드명, 생성자명  <<-- 접근 제어자가 반드시 할당이 되어있다.
		//클래스 이름 : public, default 만 

public class A {
	
	 int m = 3; 	 //필드의 기본 접근 제어자는 default : 생략됨, 같은 패키지내에서만 접근가능
	 int n = 4;	 	/* default : 같은 패키지내에 다른 클래스에서 접근이 가능
	...
	public void print2() {
		System.out.println("외부 패키지의 다른 클래스에서 접근가능 " + k);
	}
