...
class Animal3 {  //부모 클래스, 모든 클래스는 Object 클래스를 상속한다.(extends Object)
	String name ;
	int age ;
...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(a3);  //객체 자체를 출력 할 경우, Object 클래스의 toStirng 메소드가 호출
		...
		Animal3 t3 = new Tiger3(); //업캐스팅
		Animal3 c3 = new Cat3();  // 업캐스팅
		Animal3 d3 = new Dog3();
		
		t3.cry(); //부모의 cry() 호출시 오버라이딩된 Tiger3의 cry() 호출
		c3.cry(); //부모의 cry() 호출시 오버라이딩된 Cat3의 cry() 호출
		d3.cry();
