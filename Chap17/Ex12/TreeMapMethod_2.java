...
//		
//		treeMap1.put(m1, "첫번째");	//Comparable, Comparator 를 구현하지 않았는데 TreeMap의 Key로 사용, 실행시 오류
//		treeMap1.put(m2, "두번째");
//		
//		System.out.println(treeMap1);	//실행시 오류
		
		//2. Compareble을 구현한 클래스를 사용.
		...
		treeMap2.put(my1, "첫번쨰");
		treeMap2.put(my3, "세번째");
		treeMap2.put(my2, "두번쨰");
		
		System.out.println(treeMap2);
		System.out.println(treeMap2.size());
		
		//3. Comparator 를 구현 : 기존의 객체를 사용, 객체 수정이 불필요하다.
