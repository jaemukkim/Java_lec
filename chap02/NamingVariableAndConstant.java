...
public class NamingVariableAndConstant {
	public static void main(String[] args) {
		...
		char $ab_cd;	//변수명에 $, _ 두가지만 사용할 수 있다.
		//char ab cd; 		//공백이나 다른 특수문자는 넣을 수 없다.
		long abcd3;			//변수명에 숫자를 넣을 수 있다. 단 첫번째 단어에 숫자가 오면 변수 발생
		//long 3abcd;		//첫 글자에 숫자가 오면 오류 발생
		double main;	//
		//double class;		//자바에서 사용하는 예약어들은 변수 명으로 사용할 수 없다.(class)
		...
		aBcD = true;	//aBcD는 true, false 만 가능 (boolean)
