...
public class OperatorEx03 {
	public static void main(String[] args) {
		...
		//1. 논리 연산자 AND (&&) : 두 항이 모두 true 일때 결과가 true
		...
		System.out.println(true || true); //true, 쇼트서킷이 발생.(앞이 true니 뒤는 안봄)
		...
		int value2 = 3;
		System.out.println(false && ++value2 > 6); //fasle, 쇼트서킷이 발생
		System.out.println(value2);		// 3, 위에 뒤에 계산안함(쇼트서킷)
		
		int value3 = 3;
		System.out.println(false & ++value3 >6); //false, 쇼트서킷이 발생안됨
		System.out.println(value3); //4
		
		int value4 = 3;
		System.out.println(true || ++value4 > 6); //true
		System.out.println(value4); //3, 쇼트서킷 발생
		
		int value5 = 3;
		System.out.println(true | ++value5 > 6); //true
		System.out.println(value5); //4, 쇼트서킷 발생되지 않음
