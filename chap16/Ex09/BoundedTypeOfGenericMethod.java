...
class B {	// 제너릭 타입 내부에서 인터페이스를 적용할 때는 extends 키를 사용한다.
	public <T extends MyInterface> void method2 (T t) {	//T에 타입에 올 수 있는 것은 MyInterface를
														//구현한 클래스만 올 수 있다.
		t.print();
	}
}
...
//		a.<Boolean>method1(true); 		//Chartor, Boolean은 오류발생.
		
		B b = new B();		// 일반클래스에 제너릭메소드
